-- Sprint 13 — limite unità per manager (somma su tutti i workspace creati da auth.uid()).
-- Numeri allineati a src/lib/billing-plan-policy.ts (aggiornare entrambi se cambiano).
