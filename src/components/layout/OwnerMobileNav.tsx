...
const LINKS = [
  { href: '/owner', label: 'Home', match: 'exact' as const },
  { href: '/owner/approvals', label: 'Approvals', match: 'prefix' as const },
  { href: '/owner/units', label: 'Units', match: 'prefix' as const },
  { href: '/owner/cases', label: 'Cases', match: 'prefix' as const },
  { href: '/account/billing', label: 'Billing', match: 'prefix' as const },
  { href: '/account/preferences', label: 'Preferences', match: 'prefix' as const },
  { href: '/onboarding/owner', label: 'Setup', match: 'prefix' as const },
] as const
    ...
    >
      <div className="flex items-center justify-between min-h-[var(--s12)] gap-4">
        ...
        <button
          ...
          aria-expanded={open}
          aria-controls="owner-mobile-drawer"
      ...
      <MobileNavDrawer
        ...
        drawerId="owner-mobile-drawer"
        dialogAriaLabel="Owner navigation"
        title="Navigation"
